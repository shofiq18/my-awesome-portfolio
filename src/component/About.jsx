    ...
    <div id="about" className="py-20 bg-gray-900 z-50 text-gray-300">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-12">
          ...
          {/* Content Section */}
          <motion.div className="p-5 md:p-10 text-lg text-justify max-w-2xl bg-gray-950 rounded-md shadow-[0px_0px_10px_10px_rgba(0,0,0,0.3)] shadow-blue-500"
          ...
          >
            ...
            <p className="mt-4">
              ...
              problems and creating impactful digital solutions. Over time, I
              have honed my skills in frontend and backend technologies, and I
              thoroughly enjoy tackling challenging projects that require
              innovative solutions.
            </p>
            <p className="mt-4">
              Outside of coding, I love exploring new technologies, reading
              about software development trends, and sharing my knowledge with
              the community. In my free time, I enjoy photography, playing
              chess, and traveling to discover new cultures.
            </p>
          </motion.div>
        </div>
      </div>
